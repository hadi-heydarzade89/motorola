	  ...
	  booklyAjax({
	    ...
	    if (response.final_step_url && !data.error) {
	      ...
	      $__default["default"]('.bookly-js-download-ics', $container).on('click', function (e) {
	        ...
	        window.location = BooklyL10n.ajaxurl + (_indexOfInstanceProperty(_context = BooklyL10n.ajaxurl).call(_context, '?') > 0 ? '&' : '?') + 'action=bookly_download_ics&form_id=' + params.form_id + '&csrf_token=' + BooklyL10n.csrf_token;
	        _setTimeout(function () {
	          return ladda.stop();
	        }, 1500);
	      });
	      $__default["default"]('.bookly-js-download-invoice', $container).on('click', function (e) {
	        var _context2;
	        var ladda = laddaStart(this);
	        window.location = BooklyL10n.ajaxurl + (_indexOfInstanceProperty(_context2 = BooklyL10n.ajaxurl).call(_context2, '?') > 0 ? '&' : '?') + 'action=bookly_invoices_download_invoice&form_id=' + params.form_id + '&csrf_token=' + BooklyL10n.csrf_token;
	        _setTimeout(function () {
	          return ladda.stop();
	        }, 1500);
	      });
	    ...
	    $next_btn.on('click', function (e, force_update_customer) {
	      ...
	      if ($terms.length && !$terms.prop('checked')) {
	        ...
	        $__default["default"]('.bookly-custom-fields-container', $container).each(function () {
	              ...
	              switch ($this.data('type')) {
	                ...
	                case 'file':
	                  custom_fields_data.push({
	                    id: $this.data('id'),
	                    value: _findInstanceProperty($this).call($this, 'input.bookly-custom-field').val()
	                  });
	                  break;
	                case 'textarea':
	                  custom_fields_data.push({
	                    id: $this.data('id'),
	                    value: _findInstanceProperty($this).call($this, 'textarea.bookly-custom-field').val()
	                  });
	                  break;
	                case 'checkboxes':
	                  checkbox_values = [];
	                  _findInstanceProperty($this).call($this, 'input.bookly-custom-field:checked').each(function () {
	                    checkbox_values.push(this.value);
	                  });
	                  custom_fields_data.push({
	                    id: $this.data('id'),
	                ...
	                case 'radio-buttons':
	                  custom_fields_data.push({
	                    id: $this.data('id'),
	                    value: _findInstanceProperty($this).call($this, 'input.bookly-custom-field:checked').val() || null
	                  });
	                  break;
	                case 'drop-down':
	                  custom_fields_data.push({
	                    id: $this.data('id'),
	                    value: _findInstanceProperty($this).call($this, 'select.bookly-custom-field').val()
	                  });
	                  break;
	                case 'number':
	                  custom_fields_data.push({
	                ...
	                case 'date':
	                  custom_fields_data.push({
	                    id: $this.data('id'),
	                    value: _findInstanceProperty($this).call($this, 'input.bookly-custom-field').pickadate('picker').get('select', 'yyyy-mm-dd')
	                  });
	                  break;
	                case 'captcha':
	                  custom_fields_data.push({
	          ...
	          custom_fields[key] = {
	            custom_fields: _JSON$stringify(custom_fields_data)
	          };
	        });
	        try {
	            ...
	            if (response.custom_fields) {
	              $__default["default"].each(response.custom_fields, function (key, fields) {
	                $__default["default"].each(fields, function (field_id, message) {
	                  ...
	                  _findInstanceProperty($div).call($div, '.bookly-custom-field').addClass('bookly-error');
	                  if ($scroll_to === null) {
	                    $scroll_to = _findInstanceProperty($div).call($div, '.bookly-custom-field');
	                  }
	                });
	              });
	            }
