...
if ( ! class_exists( 'PW_WC_Admin' ) ) {
    ...
    class PW_WC_Admin {
        ...
        public function __construct() {
            $is_jalali_enabled = PW()->get_options( 'enable_jalali_datepicker', 'no' ) == 'yes';
            $is_correct_page   = $this->is_correct_page();

            if ( $is_jalali_enabled && $is_correct_page ) {
