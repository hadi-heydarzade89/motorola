    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'		=> esc_html__( 'SAVE UP TO', 'electro' )
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'		=> esc_html__( 'Start Buying', 'electro' )
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Electro_Elementor_Banner_With_Products_Carousel );