...
/**
 * Elementor Products Carousel Categories With Image Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Electro_Elementor_Products_Carousel_Categories_With_Image extends Widget_Base {

    /**
     * Get widget name.
     *
     * Retrieve Products Carousel Categories With Image widget name.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_name() {
        return 'electro_elementor_products_carousel_category_with_image_block';
    }

    /**
     * Get widget title.
     *
     * Retrieve Products Carousel Categories With Image widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_title() {
        return esc_html__( 'Products Carousel Categories and Image', 'electro-extensions' );
    }

    /**
     * Get widget icon.
     *
     * Retrieve Products Carousel Categories With Image widget icon.
     *
     * @since 1.0.0
     * @access public
     *
     ...
     *
     * Retrieve the list of categories the Products Carousel Categories With Image widget belongs to.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    /**
     * Register Products Carousel Categories With Image widget controls.
     *
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'description',
            [
                'label'         => esc_html__('Enale product description ', 'electro-extensions'),
    ...
    /**
     * Render Products Carousel Categories With Image output on the frontend.
     *
    ...
    protected function render() {
        ...
        $shortcode_atts = wp_parse_args( $shortcode_atts, array( 'order' => $order, 'orderby' => $orderby,'per_page' => $limit, 'columns' => $items ) );
...
Plugin::instance()->widgets_manager->register_widget_type( new Electro_Elementor_Products_Carousel_Categories_With_Image );