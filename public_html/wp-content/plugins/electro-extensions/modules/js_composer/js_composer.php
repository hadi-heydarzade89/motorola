...
if( ! class_exists( 'Electro_VCExtensions' ) ) {
	class Electro_VCExtensions {
		...
		public function includes() {
			...
			require_once ELECTRO_VC_PLUGIN_EXTENSIONS_DIR . '/includes/elements/vc-product-categories-block-v2.php';
			...
			require_once ELECTRO_VC_PLUGIN_EXTENSIONS_DIR . '/includes/elements/vc-slider-with-ads-block-v2.php';
			require_once ELECTRO_VC_PLUGIN_EXTENSIONS_DIR . '/includes/elements/vc-sidebar-with-products.php';
			require_once ELECTRO_VC_PLUGIN_EXTENSIONS_DIR . '/includes/elements/vc-brands-with-category-block.php';
			require_once ELECTRO_VC_PLUGIN_EXTENSIONS_DIR . '/includes/elements/vc-banner-with-products-carousel.php';
			require_once ELECTRO_VC_PLUGIN_EXTENSIONS_DIR . '/includes/elements/vc-brands-block.php';
			require_once ELECTRO_VC_PLUGIN_EXTENSIONS_DIR . '/includes/elements/vc-blog-posts-block.php';
			require_once ELECTRO_VC_PLUGIN_EXTENSIONS_DIR . '/includes/elements/vc-three-banners.php';
