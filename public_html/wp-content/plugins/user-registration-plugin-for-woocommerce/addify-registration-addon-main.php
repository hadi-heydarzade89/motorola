<?php 
/**
 * Plugin Name:       افزونه سفارشی سازی فیلدهای ثبت نام کاربران ووکامرس
 * Plugin URI:        https://woocommerce.com/products/custom-user-registration-fields-for-woocommerce/
 * Description:       افزونه شخصی سازی فیلدهای ثبت نام کاربران ووکامرس به شما امکان می دهد فیلدهای اضافی را به فرم ثبت نام خود اضافه کنید. پشتیبانی از 14 نوع فیلد. ووکامرس فارسی.
 * Version:           1.7.2
