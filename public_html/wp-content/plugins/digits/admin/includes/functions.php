...
{
    check_ajax_referer('digits_setting_save');
        ...
        <tr>
            ...
            <td>
                ...
                <select name="phonenumberdenylist[]"
                        class="dig_ignore_select2 phonenumberdenylist dig_multiselect_dynamic_enable"
                        multiple="multiple">
                    <?php
        ...
        <tr>
            ...
            <td>
                ...
                <select name="brute_force_allowed_ip[]"
                        class="dig_ignore_select2 dig_multiselect_dynamic_enable"
                        multiple="multiple">
                    <?php
