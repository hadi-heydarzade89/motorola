...
function digits_additional_gateways_list()
{
    return array(
        ...
        'Gateway' => array(
            ...
            'label' => 'Gateway.sa',
            'inputs' => array(
                __('API ID') => array('text' => true, 'name' => 'username'),
                __('API Password') => array('text' => true, 'name' => 'password'),
                __('Sender') => array('text' => true, 'name' => 'sender', 'optional' => 1),
        ...
        'GupShup' => array(
            ...
            'require_addon' => 1,
            'inputs' => array(
                __('APP ID') => array('text' => true, 'name' => 'app_id'),
                __('API Key') => array('text' => true, 'name' => 'api_key'),
                __('Sender') => array('text' => true, 'name' => 'sender', 'optional' => 1),
            ),
        ),
        ...
        'smsconnexion' => array(
            ...
            'inputs' =>
                array(
                    __('API Token') => array('text' => true, 'name' => 'access_token'),
                    __('From') => array('text' => true, 'name' => 'from', 'optional' => 1),
                )
        ),
