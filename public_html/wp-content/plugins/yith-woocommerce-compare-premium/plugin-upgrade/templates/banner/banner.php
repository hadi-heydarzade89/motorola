...
?>
	<div class="<?php echo esc_attr( $classes ); ?>" data-slug="<?php echo esc_attr( $slug ); ?>" data-security="<?php echo esc_attr( wp_create_nonce( $slug ) ); ?>">
		...
		<div class="yith-plugin-upgrade-licence-banner__content">
			<div class="yith-plugin-upgrade-licence-banner__content__head">
				<div class="yith-plugin-upgrade-licence-banner--hide-inline"><?php esc_html_e( 'Please, enter a license key to use', 'yith-plugin-upgrade-fw' ); ?></div>
				<div class="yith-plugin-upgrade-licence-banner--hide-modal"><?php esc_html_e( 'Please, enter a license key to use this plugin.', 'yith-plugin-upgrade-fw' ); ?></div>
				<div class="yith-plugin-upgrade-licence-banner__content__plugin-name yith-plugin-upgrade-licence-banner--hide-inline"><?php echo esc_html( $plugin_name ); ?></div>
			</div>
			<div class="yith-plugin-upgrade-licence-banner__content__message">
				<span class="yith-plugin-upgrade-licence-banner--hide-inline">
				...
				<span class="yith-plugin-upgrade-licence-banner--hide-modal">
