...
function yith_woocompare_premium_install_woocommerce_admin_notice() {
	?>
	<div class="error">
		<p><?php esc_html_e( 'YITH WooCommerce Compare Premium is enabled but not effective. It requires WooCommerce in order to work.', 'yith-woocommerce-compare' ); ?></p>
	</div>
	<?php
}
...
if ( ! defined( 'YITH_WOOCOMPARE_VERSION' ) ) {
	define( 'YITH_WOOCOMPARE_VERSION', '2.40.0' );
}
