...
<form class="woocommerce-EditAccountForm edit-account sdf" action=""
    ...
    <p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
        ...
        <input type="text" class="woocommerce-Input woocommerce-Input--text input-text"
               ...
               name="user_account_national_id" <?= $readOnly ?>
               id="user_account_national_id" value="<?php echo esc_attr($nationalId); ?>"/>
        <span><em>شما می توانید فقط کد ملی را وارد نمایید. برای ویرایش آن به ادمین باید درخواست دهید.</em></span>
    </p>
