...
class DigitsMainJsFile
{
    ...
    {
//        add_action('wp_enqueue_scripts', [$this, 'digitsAddScripts'], 9999);
//        add_action('login_enqueue_scripts', [$this, 'digitsAddScripts']);
    }
     ...
     * @return void
     */
    public function digitsAddScripts($usercode = 0)
    {
        ...
        wp_register_script('digits-main-script', get_theme_file_uri('assets/js/digits/main.min.js'), dig_deps_scripts(), digits_version(), true);
        wp_enqueue_style('electro-child-theme', get_stylesheet_uri(), [], wp_get_theme()->get('Version'));
